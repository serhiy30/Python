...
The system also integrates with **Microsoft Graph API** to automatically send email notifications with attached reports.  
All credentials and tokens are securely stored in **Azure Key Vault** via `dbutils.secrets`.
...
# 🚀 Automatisiertes Berichtssystem für Bestands- und Preisänderungen
...
Das System ist außerdem mit der **Microsoft Graph API** integriert, um automatisch E-Mail-Benachrichtigungen mit angehängten Berichten zu versenden.  
Alle Anmeldedaten und Tokens werden über **dbutils.secrets** sicher in **Azure Key Vault** gespeichert.
...
<img src="https://github.com/user-attachments/assets/b84f9fdf-2f7b-421f-a7b5-826049de4e92" width="600"/>
